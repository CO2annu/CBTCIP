...
public class depositmoney {
	...
	public void deposit(){
		final JFrame f=new JFrame("Deposit");
	    JLabel l1 , l2;  
	    ...
	    JButton login_but=new JButton("Deposit");
	    ...
	    public void actionPerformed(ActionEvent e){ 
	        ...
	        try {
				...
				if (rs.next()) {
	                ...
	                JOptionPane.showMessageDialog( null , "Updated balance for " + username + ": " + updatedAmount);
	                f.dispose();
	            }
				else
			{
...
//		}
//		System.out.println("enter name you want to deposit money in");
//		String s = sc.next();
